...
// i-am folosit mostly pentru ease of use dar avem si un camp alocat dinamic in clasa Entry si in functia string* split_string_into_words(string userInput)
